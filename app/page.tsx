...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '24px', maxWidth: 1200, margin: '0 auto', width: '100%', boxSizing: 'border-box' as const }}>
