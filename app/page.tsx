...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '24px', maxWidth: 1000, margin: '0 auto', width: '100%', boxSizing: 'border-box' as const }}>
