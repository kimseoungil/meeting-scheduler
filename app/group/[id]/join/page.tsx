...
export default function JoinPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main style={{ minHeight: '100dvh', padding: '20px', maxWidth: 800, margin: '0 auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', boxSizing: 'border-box' as const }}>
